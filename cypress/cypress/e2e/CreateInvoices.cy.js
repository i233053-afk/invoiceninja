...
// Test Suite
// ========================================
describe('Invoice Form – Invalid Input Minimal Set', () => {
...
//   // ============================================================
  ...
  // // ============================================================
  // // TC03 – Invoice # = "@@@###" (invalid format)
  // // ============================================================
   it('TC03 – Reject invalid Invoice # special characters', () => {
    cy.selectFirstReactSelect('Ayesha');
    typeByLabel('Invoice #', '@@@###');
    
    cy.contains('button', 'Save').click({ force: true });

    cy.contains("Invoice", { timeout: 6000 })
    .should("exist");
    cy.screenshot('TC_03')
   });
  ...
  // // ============================================================
  // // TC05 – PO # extremely long (500 chars)
  // // ============================================================
...
//   // ============================================================
//   // TC06 – Discount Amount = -5 (invalid negative)
//   // ============================================================
