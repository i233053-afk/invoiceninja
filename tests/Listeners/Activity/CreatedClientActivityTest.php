...
class CreatedClientActivityTest extends TestCase
{
    ...
    public function it_saves_activity_with_user_id_from_event_vars()
    {
        ...
        $activityRepoMock->shouldReceive('save')
            ...
            ->withArgs(function ($fields, $client, $event_vars) {
                ...
                $this->assertEquals(Activity::CREATE_CLIENT, $fields->activity_type_id);
                return true;
            });

        $listener = new CreatedClientActivity($activityRepoMock);
